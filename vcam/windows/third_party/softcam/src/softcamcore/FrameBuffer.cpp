...
// [webcam-bridge] own names so a softcam-based app elsewhere cannot clash
const char NamedMutexName[] = "Webcam Bridge/NamedMutex";
const char SharedMemoryName[] = "Webcam Bridge/SharedMemory";
